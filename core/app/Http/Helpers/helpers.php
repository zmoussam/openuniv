...
function array_content_to_html($arry)
{
    if (isset($arry) && ($arry != null)&& is_array($arry)) {
        $new_array=[];
        foreach ($arry as $key => $value) {
            $new_array[$key] = ($value == "<br>" || $value == null)? null :htmlspecialchars($value);
        }
        return $new_array;
    }
    return null;
...
function array_content_to_string($arry)
{
    if (isset($arry) && ($arry != null)&& is_array($arry)) {
        $new_array=[];
        foreach ($arry as $key => $value) {
            $new_array[$key] = htmlspecialchars_decode($value);
        }
        return $new_array;
    }
    return null;
