...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ProductController')->prefix('product')->name('product.')->group(function(){
        ...
        Route::get('all/attr', 'all_attr')->name('all.attr');
        Route::post('add/attr', 'add_attr')->name('add.attr');
        Route::get('form/attr/{id?}', 'form_attr')->name('form.attr');

    });
    //knowledge base
    
     // Article 
    Route::controller('Article')->prefix('article')->name('article.')->group(function(){
        Route::get('all', 'all')->name('all');
        Route::get('form/{id?}', 'form')->name('form');
        Route::post('form/{id?}', 'form')->name('form');
        Route::post('add', 'add')->name('add');
        Route::post('update', 'update')->name('update');
        Route::post('delete/{id}', 'delete')->name('delete');
    });
       // Course Category  
       Route::controller('CoursecategoryController')->prefix('coursecategory')->name('coursecategory.')->group(function(){
        Route::get('all', 'all')->name('all');
        Route::post('add', 'add')->name('add');
        Route::post('update', 'update')->name('update');
        Route::post('status/{id}', 'status')->name('status');
