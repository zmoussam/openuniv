...
<head>
    ...
    {{-- zakaria add this line for styles --}}
    <link href="https://assets-global.website-files.com/66171462efa71abbce3940c6/css/staging-kajabi-marketing.291d51b0d.min.css" rel="stylesheet" type="text/css" />
    {{-- end of zakaria styles --}}
    @stack('style-lib')
